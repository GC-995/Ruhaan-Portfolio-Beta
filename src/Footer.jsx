      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-left mb-8 md:mb-0">
            <h3 className="text-3xl font-extrabold text-white mb-2 tracking-wide">
              Ruhaan<span className="text-accent">.</span>
            </h3>
          ...
          <div className="flex gap-8">
            ...
            <a
              href="https://www.linkedin.com/in/rs995/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-white hover:scale-110 transition-all duration-300"
              aria-label="LinkedIn"
            ...
            <a
              href="https://x.com/_RuhaanSharma_"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-white hover:scale-110 transition-all duration-300"
              aria-label="Twitter"
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} <span className="text-white font-medium">Ruhaan Sharma</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
